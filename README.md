...
Use **[ProperTree](https://github.com/corpnewt/ProperTree/zipball/master/)** to edit the **`config.plist`** file and change **PlatformInfo** values to your own machine:
- **MLB**, **SystemSerialNumber** and **SystemUUID** can be generated by **[GenSMBIOS utility](https://github.com/corpnewt/GenSMBIOS/zipball/master/)**;
